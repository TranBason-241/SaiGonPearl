...
var ggAPI = "https://script.google.com/macros/s/AKfycbyE1Xu_ZF07z7KGXJPdDXMQ31D3S-gDDEFCtdlK7vfvbU2WnB-N3Dgtm0x453PYiv6kSQ/exec";
...
btnNavs.forEach((element) => {
  element.addEventListener("click", (e) => {
    ...
    imgList = document.querySelectorAll(".schedule-img")[index].classList.add("active");
  });
});
...
// xét data của khảo sát khi click ra ngoài

clearModalSurvey = () => {
  list = document.querySelectorAll(".question-modal .item");
  list.forEach((element) => {
    _data[element.getAttribute("id")] = "";
  });
};
...
document.querySelector(".btn-submit-modal-survey").addEventListener("click", () => {
  if (checkPopupSurvey()) {
    // co lam
    ...
    setTimeout(() => {
      Swal.fire({
        ...
        html: "<p>Cảm ơn bạn đã tham gia khảo sát</p>",
        // html:
...
// check có điền khảo sát hay không

var checkPopupSurvey = () => {
  list = document.querySelectorAll(".question-modal .item");
  isDoSurvey = false;
  list.forEach((element) => {
    if (_data[element.getAttribute("id")] !== undefined) {
      isDoSurvey = true;
    }
  });
  return isDoSurvey;
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.result == "success") {
        ...
        ques = document.querySelectorAll("h4.d-none");
